  ...
  (
    ...
    const centerPages = () => {
      ...
      if (currentPage === 2) {
        ...
        pages = Array.from({ length: 4 }, (_, index) => currentPage + 1 + index);
      } else {
      ...
      if (variant === 'compact') {
        if (currentPage === 2) {
          ...
          pages = Array.from({ length: 2 }, (_, index) => totalPages - 2 + index);
        } else if (currentPage !== 1 && currentPage !== totalPages) {
          pages = Array.from({ length: 1 }, (_, index) => currentPage + index);
        } else if (currentPage === 1) {
          pages = Array.from({ length: 2 }, (_, index) => currentPage + 1 + index);
        } else {
          pages = Array.from({ length: 1 }, (_, index) => totalPages - 3 + index);
        }
      }
