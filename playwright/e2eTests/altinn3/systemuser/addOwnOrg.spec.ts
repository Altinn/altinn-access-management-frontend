...
test.describe('Systembruker - Legg til egen organisasjon', () => {
  ...
  test('Legg til din virksomhet', async ({
    ...
    runAccessibilityTest.setTestData({ from: systemUserOwner, systemId, vendorOrgNumber });
    ...
    await runAccessibilityTest.scan(testInfo, 'systembruker-med-egen-organisasjon');
