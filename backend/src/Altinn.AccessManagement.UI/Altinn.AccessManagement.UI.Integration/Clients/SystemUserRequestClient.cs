...
namespace Altinn.AccessManagement.UI.Integration.Clients
{
    ...
    public class SystemUserRequestClient : ISystemUserRequestClient
    {
        ...
        /// <inheritdoc/>
        public async Task<Result<SystemUserRequest>> GetSystemUserRequest(Guid requestId, CancellationToken cancellationToken)
        {        
            try
            {
        ...
        /// <inheritdoc/>
        public async Task<Result<List<SystemUserRequest>>> GetPendingSystemUserRequests(int partyId, string orgNo, CancellationToken cancellationToken)
        {
            try
            {
                string token = JwtTokenUtil.GetTokenFromContext(_httpContextAccessor.HttpContext, _platformSettings.JwtCookieName);
