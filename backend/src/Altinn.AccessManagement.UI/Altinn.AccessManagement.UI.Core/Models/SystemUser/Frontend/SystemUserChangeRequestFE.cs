...
{
    /// <summary>
    /// Response DTO through the API after Vendor calls to update a SystemUser
    /// </summary>
    public class SystemUserChangeRequestFE
    {
        /// <summary>
        ...
        /// <summary>
        /// Optional redirect URL to navigate to after the customer has accepted/denied the change request
        /// </summary>    
