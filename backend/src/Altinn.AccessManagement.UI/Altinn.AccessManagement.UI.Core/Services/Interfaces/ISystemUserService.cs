...
namespace Altinn.AccessManagement.UI.Core.Services.Interfaces
{
    ...
    public interface ISystemUserService
    {
        ...
        /// <summary>
        /// Return all client system users created for a given party
        /// </summary>
        /// <param name="partyId">The party Id of the party to retrieve</param>
        /// <param name="languageCode">Language code. Can be either nb, nn or en</param>
        /// <param name="cancellationToken">Cancellation token</param>
        /// <returns>List of all system users for specified party</returns>
        Task<Result<List<SystemUserFE>>> GetClientSystemUsersForParty(int partyId, string languageCode, CancellationToken cancellationToken);
        ...
        /// <param name="cancellationToken">Cancellation token</param>
        /// <returns>Requested system user</returns>
        Task<SystemUserFE> GetClientSystemUser(int partyId, Guid id, string languageCode, CancellationToken cancellationToken);
