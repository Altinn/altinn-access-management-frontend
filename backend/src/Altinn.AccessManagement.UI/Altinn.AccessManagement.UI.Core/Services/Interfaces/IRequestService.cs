...
namespace Altinn.AccessManagement.UI.Core.Services.Interfaces
{
    ...
    public interface IRequestService
    {
        ...
        Task<IEnumerable<SingleRightRequest>> GetSingleRightRequests(Guid party, Guid to, Guid from, List<RequestStatus> status, CancellationToken cancellationToken);
        ...
        /// <param name="cancellationToken">Cancellation token</param>
        /// <returns>The http response from backend</returns>
        Task<bool> CreateSingleRightRequest(Guid party, Guid to, Guid from, string resource, CancellationToken cancellationToken);
