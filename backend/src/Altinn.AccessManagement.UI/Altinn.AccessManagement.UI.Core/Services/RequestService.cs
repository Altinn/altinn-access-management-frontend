...
namespace Altinn.AccessManagement.UI.Core.Services
{
    ...
    public class RequestService : IRequestService
    {
        ...
        /// <inheritdoc />
        public async Task<IEnumerable<SingleRightRequest>> GetSentRequests(Guid party, Guid? to, List<RequestStatus> status, string type, CancellationToken cancellationToken)
        {
        ...
        /// <inheritdoc />
        public async Task<IEnumerable<SingleRightRequest>> GetReceivedRequests(Guid party, Guid? from, List<RequestStatus> status, string type, CancellationToken cancellationToken)
        {
