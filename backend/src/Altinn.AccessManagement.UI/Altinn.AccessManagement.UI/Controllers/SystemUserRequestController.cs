...
namespace Altinn.AccessManagement.UI.Controllers
{
    ...
    {       
        ...
        public async Task<ActionResult> GetRequestByPartyIdAndRequestId([FromRoute] int partyId, [FromRoute] Guid requestId, CancellationToken cancellationToken = default)
        {
        ...
        public async Task<ActionResult> ApproveSystemUserRequest([FromRoute] int partyId, [FromRoute] Guid requestId, CancellationToken cancellationToken = default)
        {
        ...
        public async Task<ActionResult> RejectSystemUserRequest([FromRoute] int partyId, [FromRoute] Guid requestId, CancellationToken cancellationToken = default)
        {
