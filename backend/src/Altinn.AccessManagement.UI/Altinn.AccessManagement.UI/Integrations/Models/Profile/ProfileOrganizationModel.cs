...
namespace Altinn.AccessManagement.UI.Integrations.Profile.Models
{
    ...
    public partial class ProfileOrganizationModel : IValidatableObject
    {
        ...
        public ProfileOrganizationModel(string orgNumber = default(string), string name = default(string), string unitType = default(string), string telephoneNumber = default(string), string mobileNumber = default(string), string faxNumber = default(string), string eMailAddress = default(string), string internetAddress = default(string), string mailingAddress = default(string), string mailingPostalCode = default(string), string mailingPostalCity = default(string), string businessAddress = default(string), string businessPostalCode = default(string), string businessPostalCity = default(string), string unitStatus = default(string))
        {
