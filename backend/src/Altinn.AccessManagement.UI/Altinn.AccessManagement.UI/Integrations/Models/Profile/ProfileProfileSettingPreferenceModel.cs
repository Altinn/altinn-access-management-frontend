...
namespace Altinn.AccessManagement.UI.Integrations.Profile.Models
{
    ...
    public partial class ProfileProfileSettingPreferenceModel : IValidatableObject
    {
        ...
        public ProfileProfileSettingPreferenceModel(string languageType = default(string), string language = default(string), int preSelectedPartyId = default(int), bool doNotPromptForParty = default(bool))
        {
        ...
        /// </summary>
        [DataMember(Name = "languageType", EmitDefaultValue = true)]
