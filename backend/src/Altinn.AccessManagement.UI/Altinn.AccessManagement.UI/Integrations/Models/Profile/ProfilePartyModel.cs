...
namespace Altinn.AccessManagement.UI.Integrations.Profile.Models
{
    ...
    public partial class ProfilePartyModel : IValidatableObject
    {
        ...
        public ProfilePartyTypeModel? PartyTypeName { get; set; }
        /// <summary>
        ...
        public ProfilePartyModel(int partyId = default(int), Guid? partyUuid = default(Guid?), ProfilePartyTypeModel? partyTypeName = default(ProfilePartyTypeModel?), string orgNumber = default(string), string ssn = default(string), string unitType = default(string), string name = default(string), bool isDeleted = default(bool), bool onlyHierarchyElementWithNoAccess = default(bool), ProfilePersonModel person = default(ProfilePersonModel), ProfileOrganizationModel organization = default(ProfileOrganizationModel), List<ProfilePartyModel> childParties = default(List<ProfilePartyModel>))
        {
        ...
        public List<ProfilePartyModel> ChildParties { get; set; }
