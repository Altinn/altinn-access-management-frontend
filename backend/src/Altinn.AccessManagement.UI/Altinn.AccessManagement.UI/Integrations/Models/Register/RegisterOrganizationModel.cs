...
namespace Altinn.AccessManagement.UI.Integrations.Register.Models
{
    ...
    public partial class RegisterOrganizationModel : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RegisterOrganizationModel" /> class.
        /// </summary>
        /// <param name="orgNumber">Identifier.</param>
        /// <param name="name">Name of the organization.</param>
        /// <param name="unitType">Unit Type.</param>
        public RegisterOrganizationModel(string orgNumber = default(string), string name = default(string), string unitType = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RegisterOrganizationModel {\n");
