...
- Clone following [repo](https://github.com/Altinn/app-localtest) and checkout branch AccessManagement-LocalTest. Also remember to follow readme in that branch (Because localtest for podman doesn't work yet). You have completed this step when you can run localtest.
