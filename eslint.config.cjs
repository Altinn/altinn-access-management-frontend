...
module.exports = defineConfig([
  globalIgnores([
    ...
    '.yarn/**',
    // Generated by running the Playwright suite locally - never source, but
    // matched by lintedFiles' extensions and slow enough (bundled trace-viewer
    // assets) to make `eslint .` hang for minutes if not excluded.
    'playwright/playwright-report/**',
    'playwright/test-results/**',
    'playwright/jsonReports/**',
  ]),
